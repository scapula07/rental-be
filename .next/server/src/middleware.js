...
/* harmony default export */ const src_middleware = ((0,middleware.withAuth)(function middleware(request) {
    // ** exclude the auth routes
    // console.log(request.nextUrl.pathname, "running middleware");
    if (request.nextUrl.pathname.startsWith("/api") || request.nextUrl.pathname.startsWith("/partner/auth/signin") || request.nextUrl.pathname.startsWith("/admin/auth/signin")) {
        return spec_extension_response/* NextResponse */.x.next();
    } else {
        if (request.nextUrl.pathname.startsWith("/partner") && request.nextauth.token?.role !== "partner") {
            return spec_extension_response/* NextResponse */.x.rewrite(new URL("/denied", request.url));
        }
        if (request.nextUrl.pathname.startsWith("/admin") && request.nextauth.token?.role !== "admin") {
            return spec_extension_response/* NextResponse */.x.rewrite(new URL("/denied", request.url));
        }
        if (request.nextUrl.pathname.startsWith("/dashboard") && request.nextauth.token?.role !== "user") {
            return spec_extension_response/* NextResponse */.x.rewrite(new URL("/denied", request.url));
        }
    }
}, {
    callbacks: {
        authorized: ({ req, token })=>req.nextUrl.pathname === "/partner/auth/signin" || req.nextUrl.pathname === "/admin/auth/signin" || req.nextUrl.pathname === "/auth/signin" || req.nextUrl.pathname === "/" || // req.nextUrl.pathname === "/search" ||
            !!token
    }
}));
const config = {
    matcher: [
        ...
        "/admin/((?!auth|signin|signup|forgot-password).*)",
        "/partner/((?!auth|signin|signup|forgot-password).*)",
        "/dashboard/:path*"
    ]
};

;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=%2FUsers%2Fuser%2FDesktop%2Fperzsirentals&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FkbWluKD86XFwvKCg%2FIWF1dGh8c2lnbmlufHNpZ251cHxmb3Jnb3QtcGFzc3dvcmQpLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9hZG1pbi8oKD8hYXV0aHxzaWduaW58c2lnbnVwfGZvcmdvdC1wYXNzd29yZCkuKikifSx7InJlZ2V4cCI6Il4oPzpcXC8oX25leHRcXC9kYXRhXFwvW14vXXsxLH0pKT9cXC9wYXJ0bmVyKD86XFwvKCg%2FIWF1dGh8c2lnbmlufHNpZ251cHxmb3Jnb3QtcGFzc3dvcmQpLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9wYXJ0bmVyLygoPyFhdXRofHNpZ25pbnxzaWdudXB8Zm9yZ290LXBhc3N3b3JkKS4qKSJ9LHsicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2Rhc2hib2FyZCg%2FOlxcLygoPzpbXlxcLyNcXD9dKz8pKD86XFwvKD86W15cXC8jXFw%2FXSs%2FKSkqKSk%2FKC5qc29uKT9bXFwvI1xcP10%2FJCIsIm9yaWdpbmFsU291cmNlIjoiL2Rhc2hib2FyZC86cGF0aCoifV0%3D&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FkbWluKD86XFwvKCg%2FIWF1dGh8c2lnbmlufHNpZ251cHxmb3Jnb3QtcGFzc3dvcmQpLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9hZG1pbi8oKD8hYXV0aHxzaWduaW58c2lnbnVwfGZvcmdvdC1wYXNzd29yZCkuKikifSx7InJlZ2V4cCI6Il4oPzpcXC8oX25leHRcXC9kYXRhXFwvW14vXXsxLH0pKT9cXC9wYXJ0bmVyKD86XFwvKCg%2FIWF1dGh8c2lnbmlufHNpZ251cHxmb3Jnb3QtcGFzc3dvcmQpLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9wYXJ0bmVyLygoPyFhdXRofHNpZ25pbnxzaWdudXB8Zm9yZ290LXBhc3N3b3JkKS4qKSJ9LHsicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2Rhc2hib2FyZCg%2FOlxcLygoPzpbXlxcLyNcXD9dKz8pKD86XFwvKD86W15cXC8jXFw%2FXSs%2FKSkqKSk%2FKC5qc29uKT9bXFwvI1xcP10%2FJCIsIm9yaWdpbmFsU291cmNlIjoiL2Rhc2hib2FyZC86cGF0aCoifV19!
